...
disease_symptom = {'label1':dict(),'label2':dict(),'label3':dict()}
slot_set_dict = {'label1':dict(),'label2':dict(),'label3':dict()}
goal_set_HRL = dict()
goal_set_HRL_total = dict()

for i in ['label1','label2','label3']:
    goal_set_HRL[i] = dict()
