...
slot_set = pickle.load(file=open('./dxy_dataset/dxy_dataset/100symptoms/slot_set.p', "rb"))
disease_symptom = pickle.load(file=open('./dxy_dataset/dxy_dataset/100symptoms/disease_symptom.p', "rb"))
...
slot_vector = []
disease_list = ['上呼吸道感染','肺炎','过敏性鼻炎','小儿手足口病','小儿腹泻']
...
plt.savefig('./dxy_dataset/dxy_dataset/100symptoms/similiarity.png', format='png')
pass