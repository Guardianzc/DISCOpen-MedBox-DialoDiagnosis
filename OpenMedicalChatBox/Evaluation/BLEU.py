...
import pickle
#file0 = '//remote-home/czhong/RL/data/dxy_dataset/dxy_dataset/100symptoms//'
file0 = '/remote-home/czhong/RL/data/data/dataset/label/'
#file0='/remote-home/czhong/RL/data/new_data/mz10/allsymptoms/'
goal_set = file0 + '/goal_test_set.p' 
goal_set = '/remote-home/czhong/RL/data/data/dataset/label/allsymptoms/dataset_dxy//test_goal_dict_dxy.p'
pred_path = '/remote-home/czhong/RL/Dialogue-System-for-Automatic-Diagnosis-master/records/mz-4/10.p'
...
for record in goal_set:
    ...
    goal_action_dict[record['consult_id']] = list(record['implicit_inform_slots'])
