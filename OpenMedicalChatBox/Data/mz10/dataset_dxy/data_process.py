...
file = open('dataset_dxy/symptoms_dxy.txt', 'w', encoding = 'utf-8')
for i in temp2[:-1:]:
    file.writelines(i+'\n')
...
file = open('dataset_dxy/slot_set_dxy.txt', 'w', encoding = 'utf-8')
for i in slot[:-1:]:
    file.writelines(i+'\n')
file.writelines(slot[-1])
file.close()

file = open('dataset_dxy/diseases_dxy.txt', 'w', encoding = 'utf-8')
for i in dis[:-1:]:
    file.writelines(i+'\n')
