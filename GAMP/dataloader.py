...
def LSTM_get_loader(slot_set,  disease_set, goal_test_path, batch_size=16, num_workers=4, mode='train', shuffle = True):
...
def Dis_get_loader(data_list, label, batch_size=16, num_workers=4,  shuffle = True):
...
def Inf_get_loader(data_list, label, batch_size=16, num_workers=4, mode='train', shuffle = True):
